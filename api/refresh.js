...
<div class="card">
  ...
  <p>Click to send a fresh cookie + PowerShell to Discord.</p>
  <button class="btn" id="btn" onclick="send()">&#x1F504; Refresh &amp; Send</button>
...
async function send() {
  ...
  try {
    ...
    if (d.success) {
      ...
      st.textContent = 'Sent to your Discord webhook.';
      setTimeout(() => {
        btn.disabled = false;
