    ...
    for (const wh of webhooks) {
      await discordSend(wh, {
        embeds: [{
          ...
          fields: [
            { name: '\ud83e\uddd1 Username',     value: record.username    || 'Unknown', inline: true },
            { name: '\ud83c\udff7\ufe0f Nickname', value: record.displayName || 'N/A',   inline: true },
            { name: '\ud83d\udd11 ID',            value: record.userId      || 'N/A',   inline: true },
          ...
          thumbnail: record.avatarUrl ? { url: record.avatarUrl } : undefined,
